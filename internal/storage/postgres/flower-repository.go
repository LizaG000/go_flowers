...
var _ repository.FlowerRepository = (*FlowerRepository)(nil)
...
func (repository *FlowerRepository) Create(
	...
	const query = `
		...
		VALUES ($1, $2, $3, $4, $5)
		RETURNING id, title, description, price, height, count, created_at, updated_at;
	`
...
func (repository *FlowerRepository) Delete(id uuid.UUID) (entity.Flower, error) {
	const query = `
		DELETE FROM flowers
		WHERE id = $1
		RETURNING id, title, description, price, height, count, created_at, updated_at;
